                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group  m-3">
                            ...
                            <input id="activated" name="activated" type="text" class="form-control" value="1">
                        </div>
                    </div>

                        <!-- <input type="hidden" id="create_at" name="create_at" type="text" class="form-control">
                        <input  type="hidden" id="update_at" name="update_at" type="text" class="form-control"> -->
